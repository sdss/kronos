...
.. |kronos_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('kronos')
...
man_pages = [
    (master_doc, 'kronos', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/kronos'
