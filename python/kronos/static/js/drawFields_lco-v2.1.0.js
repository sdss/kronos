...
function renderCloudCam(dataset, backups){
    ...
    image.onload = function () {
        let original = image.naturalHeight;
        let x_corner = 0;
        let y_corner = 0;
        let im_width = cnvs.width;
        let im_height = cnvs.height;
        let source_offset = 80;
        let source_width = original - 2*source_offset;
        ctx.drawImage(image, source_offset, source_offset, 
